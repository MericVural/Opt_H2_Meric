...
my_methods = [
    ...
    ('ecoinvent-3.12', 'EF v3.1', 'acidification', 'accumulated exceedance (AE)'),
...
dict_units = {
    ...
    ('ecoinvent-3.12', 'EF v3.1', 'acidification', 'accumulated exceedance (AE)'): "mol H+ -eq.", 
    ('ecoinvent-3.12', 'EF v3.1', 'ecotoxicity: freshwater', 'comparative toxic unit for ecosystems (CTUe)'): "CTUe",  
    ('ecoinvent-3.12', 'EF v3.1', 'ecotoxicity: freshwater, inorganics', 'comparative toxic unit for ecosystems (CTUe)'): "CTUe",  
    ('ecoinvent-3.12', 'EF v3.1', 'ecotoxicity: freshwater, organics', 'comparative toxic unit for ecosystems (CTUe)'): "CTUe",  
    ('ecoinvent-3.12', 'EF v3.1', 'energy resources: non-renewable', 'abiotic depletion potential (ADP): fossil fuels'): "MJ, net calorific value",  
    ('ecoinvent-3.12', 'EF v3.1', 'eutrophication: freshwater', 'fraction of nutrients reaching freshwater end compartment (P)'): "kg P-eq.",
    ('ecoinvent-3.12', 'EF v3.1', 'eutrophication: marine', 'fraction of nutrients reaching marine end compartment (N)'): "kg N-eq.",  
    ('ecoinvent-3.12', 'EF v3.1', 'eutrophication: terrestrial', 'accumulated exceedance (AE)'): "mol N-eq." ,
    ('ecoinvent-3.12', 'EF v3.1', 'human toxicity: carcinogenic', 'comparative toxic unit for human (CTUh)'): "CTUh",  
    ('ecoinvent-3.12', 'EF v3.1', 'human toxicity: carcinogenic, inorganics', 'comparative toxic unit for human (CTUh)'): "CTUh",  
    ('ecoinvent-3.12', 'EF v3.1', 'human toxicity: carcinogenic, organics', 'comparative toxic unit for human (CTUh)'): "CTUh",  
    ('ecoinvent-3.12', 'EF v3.1', 'human toxicity: non-carcinogenic', 'comparative toxic unit for human (CTUh)'): "CTUh",  
    ('ecoinvent-3.12', 'EF v3.1', 'human toxicity: non-carcinogenic, inorganics', 'comparative toxic unit for human (CTUh)'): "CTUh",  
    ('ecoinvent-3.12', 'EF v3.1', 'human toxicity: non-carcinogenic, organics', 'comparative toxic unit for human (CTUh)'): "CTUh",  
    ('ecoinvent-3.12', 'EF v3.1', 'ionising radiation: human health', 'human exposure efficiency relative to u235'): "kBq U$_{235}$-eq.",  
    ('ecoinvent-3.12', 'EF v3.1', 'material resources: metals/minerals', 'abiotic depletion potential (ADP): elements (ultimate reserves)'): "kg Sb-eq.",  
    ('ecoinvent-3.12', 'EF v3.1', 'ozone depletion', 'ozone depletion potential (ODP)'): "kg CFC-11-eq.",  
    ('ecoinvent-3.12', 'EF v3.1', 'particulate matter formation', 'impact on human health'): "disease incidence",  
    ('ecoinvent-3.12', 'EF v3.1', 'photochemical oxidant formation: human health', 'tropospheric ozone concentration increase'): "kg NMVOC-eq.",  
    ('ecoinvent-3.12', 'EF v3.1', 'water use', 'user deprivation potential (deprivation-weighted water consumption)'): "m$^{3}$ world eq. deprived",  
             }
