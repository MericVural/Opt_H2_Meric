...
LOCATIONS_SENS_PLUS = LOCATIONS_SENS + [ ["Netherlands (Schagen)", "NL", 52.75, 4.80],     ["Brazil (Rio region)", "BR", -22.50, -42.10],      ]
...
USER_NAME = "terlouw_t"
PROJECT_NAME = "optimizer_nh3_bw25" 
DB_NAME = 'db_ammonia_system' # Temp DB name for LCA activity
EI_VERSION = "3.12"
NAME_REF_DB = "ecoinvent_{}_reference".format(EI_VERSION).replace(".","")
NAME_FUTURE_DB = "ecoinvent_remind_SSP2-PkBudg1000_2050_base"
...
CC_METHOD = ('ecoinvent-3.12', 'IPCC 2021 (incl. biogenic CO2)', 
             'climate change: total (incl. biogenic CO2, incl. SLCFs)',
             'global warming potential (GWP100)') # standard method to calculate CC impacts.
